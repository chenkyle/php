...
<?php
 ...
 $sql=mysql_query("select * from tb_contactus where id=".$_GET[id]."",$conn);      
...
<table>
  <tr>
    <td colspan="2"><div class="main-title">查看修改信息</div></td>
       ...
       <form name="form1" method="post" action="../save/saveeditcontactus.php" onSubmit="return chkinput(this)">
	  <tr>
        <td >主题</td>
        <td><div align="left">
