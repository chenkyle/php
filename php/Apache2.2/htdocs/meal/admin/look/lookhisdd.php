...
$sql=mysql_query("select count(*) as total from tb_dingdan where isdelete=0",$conn);
...
//	$sql1=mysql_query("select * from tb_dingdan where zt like '%".$key."%' or zt like '%".$key1."%' order by time desc limit ".($page-1)*$pagesize.",$pagesize",$conn);
	$sql1=mysql_query("select * from tb_dingdan where isdelete=0 order by time desc limit ".($page-1)*$pagesize.",$pagesize",$conn);
