...
<table>
	...
	<tr class="member-right-sc-d">
		...
		<td class="member-right-sc-b"><a class="submodal-650-350" 
			...
			&nbsp;&nbsp;<a class="submodal-650-350" 
			href="pinglun.php?dd=<?php echo $info1[dingdanhao];?>">我要评论</a> 
		</td>
	</tr>
	<?php
	...
	<tr>
		...
		if($page>=2)
		{
			?> <a href="member_shop_history.php?page=1" title="首页"><font size="3"> 首页 </font></a>
		<a href="member_shop_history.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>"
			title="前一页"><font size="3"> 前一页 </font></a> <?php
		}
		if($pagecount<=4){
			for($i=1;$i<=$pagecount;$i++){
		  ?> <a href="member_shop_history.php?page=<?php echo $i;?>"><?php echo $i;?></a> <?php
			}
		}else{
			for($i=1;$i<=4;$i++){
		  ?> <a href="member_shop_history.php?page=<?php echo $i;?>"><?php echo $i;?></a> <?php }?>
		<a href="member_shop_history.php?page=<?php echo $page-1;?>" title="后一页"><font
			size="3"> 后一页 </font></a> <a
			href="member_shop_history.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>"
			title="尾页"><font size="3"> : </font></a> <?php }?> <input
