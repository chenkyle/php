...
<!-- 首页注册模块结束 -->
    ...
    <div class="main">
        ...
        <div class="list-right">
        	<div class="show-submenu"><a href="index.php">系统首页</a> - <a href="member.php">会员中心</a> - 查看最新订单</div>
            <!-- 会员中心右边首页开始 -->
            <div class="member-right-tit">发货中的订单</div>
            <div class="member-right-box">
            	<!-- 会员中心首页订单开始 -->
                <div class="member-right-htitle">
                    <a href="member_shop_allorder.php">所有订单</a>
                    <span class="member-right-htitle-active">发货之中</span>
                    <a href="member_shop_history.php">交易成功订单</a>
                </div>
