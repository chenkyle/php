    ...
    <div class="reg" style="height: 260px;">
        <div class="reg-main">
            ...
            <div class="reg-content">
             ...
             <div class="reg-mail">
             	<div class="reg-mail-sfu">恭喜您，<bdo class="FF3300"><?php echo $_SESSION["username"]; ?></bdo>！您的帐号<bdo class="FF3300"><?php echo $_GET[n];?></bdo>已经激活,点击<a href="index.php">这里</a>开始您的网上订餐之旅。</div>
             </div>
    	</div>
    </div>
<!-- 首页注册模块结束 -->
