...
<body>
    ...
    <div class="top">
    	...
    	<li><a href="../index.php">网站首页</a></li>
            ...
            <li>欢迎您,<?php echo $_SESSION["salername"];?> </li>
    ...
    <div class="left">
    	<div class="left-topmenu"><a href="#" title="往上拉"><img src="images/left_top_menu.png" /></a></div>
      	...
      	<div class="left-menu"><a href="#" style="background: url(images/left_menu_bg.png);">菜单管理</a></div>
      	<div class="left-submenus">
	        <ul class="left-submenu"><a href="edit/editgoods.php" target="main">菜单信息管理</a></ul> 
	        <ul class="left-submenu"><a href="show/showleibie.php" target="main">菜单类别管理</a></ul>
        </div>
        
        <div class="left-menu"><a href="#" style="background: url(images/left_menu_bg_2.png);">订单管理</a></div>
        <div class="left-submenus">
	        <ul class="left-submenu"><a href="look/lookdd.php" target="main">编辑订单</a></ul>
	        <ul class="left-submenu"><a href="find/finddd.php" target="main">查询订单</a></ul>
	    </div>
      
	    <div class="left-menu"><a href="#" style="background: url(images/left_menu_bg_2.png);">店铺管理</a></div>
        <div class="left-submenus">
	        <ul class="left-submenu"><a href="change/changedianpu.php" target="main">编辑店铺</a></ul>
	    </div>
        ...
        <div class="left-submenus">
        	...
        	<!-- <ul class="left-submenu"><a href="adminmessage.php" target="main">消息管理</a></ul>
        	<ul class="left-submenu"><a href="adminaboutus.php" target="main">关于我们</a></ul>
        	<ul class="left-submenu"><a href="admincontactus.php" target="main">联系我们</a></ul> -->
       	</div>
    	<div class="left-menu"><a href="#" style="background: url(images/left_menu_bg_4.png);">投诉中心</a></div>
        <div class="left-submenus"> 
	        <ul class="left-submenu"><a href="change/tousu.php" target="main">投诉买家</a></ul>
	    </div> 
    ...
    <div class="main">
      ...
      <div class="main-left"></div>
   	  <div class="main-top">
        	...
        	<a href="look/lookhisdd.php" target="main">交易成功订单</a>
        	</div>
      </div>
...
(function(){
	...
	$(document).ready(function(){
        ...
        <div class="main-iframe">
        	<iframe id="main" name="main" src="look/lookdd.php" width="100%" height="590" frameBorder="0"></iframe>
        </div>
    </div>
    <!-- 页面主要内容代码结束 -->
    <!-- 页面脚部代码开始 -->
