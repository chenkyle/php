...
<table><tr><td>
<div align="left">
<input name="button" type="button" class="buttoncss-del" id="button" onClick="javascript:window.location='add/addaboutus.php';" value="添加新信息">
</div></td></tr></table>
<?php
       include("conn/conn.php");
       $sql=mysql_query("select count(*) as total from tb_aboutus ",$conn);
	   ...
	   else
	   {
           ...
           $sql1=mysql_query("select * from tb_aboutus order by time desc limit ".($page-1)*$pagesize.",$pagesize",$conn);
?>
<form name="form1" method="post" action="delete/deleteaboutus.php">
<table>
  <tr>
    <td colspan="4"><div class="main-title">关于我们</div></td>
	  ...
	  <tr>
	    ...
	    <td ><a href="edit/editaboutus.php?id=<?php echo $info1[id];?>">查看编辑</a></td>
	  </tr>
	  <?php
	       }
	  ?>
