...
?>
<script language="javascript">function chkinput(form){if(form.title.value==""){alert("请输入公告主题!");form.title.select();return(false); }if(form.EditorDefault.value==""){alert("请输入公告内容!");form.EditorDefault.select();return(false);}return(true);}</script>
<body>
<div class="main">
<table>
  <tr>
    <td colspan="2"><div class="main-title">查看修改公告</div></td>
  </tr>
       <form name="form1" method="post" action="../save/saveeditgonggao.php" onSubmit="return chkinput(this)">
	  <tr>
        <td>公告主题</td>
...
<!--        <textarea name="EditorDefault" rows="8" cols="70"></textarea>-->
      ...
      <tr>
        ...
        <input type="submit" value="更改" class="buttoncss">&nbsp;&nbsp;
