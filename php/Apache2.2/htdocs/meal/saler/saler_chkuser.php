...
$userpwd=md5($_POST[pwd]);
     ...
     $sql=mysql_query("select * from tb_user where name='".$username."'and role='卖家'",$conn);
     ...
     if($info==false){
      ...
      /*if($info[isactive]!="true"){
          ...
          if($info[pwd]==$userpwd)
            {  
			   session_start();
	           $_SESSION["salername"]=$info[name];//注册SESSION全局变量
//	           $_SESSION[user_id]=$info[id];
             ...
             header("location:admin_main.php");//送出 HTTP 协议的标头到浏览器
